...
describe("returnGroupError", () => {
  it("should return group error message", () => {
    expect(returnGroupError()).toBe("Items must be unique");
  });
});
...
describe("getTitleFromMultilingualObject", () => {
  ...
  it("should return value for current language", () => {
    const obj = { en: "English", fr: "Français" };
    // i18next.language is mocked as 'en' by default
